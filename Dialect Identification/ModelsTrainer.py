...
class ModelsTrainer:
    ...
    def process(self):
        bhojpuri, mathili, rajsthani = self.get_file_paths(self.bhojpuri_training_path,
                                             self.mathili_training_path, self.rajsthani_training_path)
        ...
        bhojpuri_gmm = GMM(n_components = 16, max_iter = 200, covariance_type='diag', n_init = 3)
        mathili_gmm   = GMM(n_components = 16, max_iter = 200, covariance_type='diag', n_init = 3)
        rajsthani_gmm   = GMM(n_components = 16, max_iter = 200, covariance_type='diag', n_init = 3)
       #n_iter
...
if __name__== "__main__":
    models_trainer = ModelsTrainer("training/bhojpuri", "training/mathili", "training/rajsthani")
